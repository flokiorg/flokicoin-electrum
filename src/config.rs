...
impl ::configure_me::parse_arg::ParseArgFromStr for BitcoinNetwork {
    fn describe_type<W: fmt::Write>(mut writer: W) -> fmt::Result {
        write!(
            writer,
            "either 'mainnet', 'testnet', 'testnet4', 'regtest' or 'signet'"
        )
    }
}
...
impl Config {
    ...
    pub fn from_args() -> Config {
        ...
        let default_daemon_rpc_port = match config.network {
            Network::Bitcoin => 15213,
            Network::Testnet => 25213,
            Network::Testnet4 => 55213,
            Network::Regtest => 35213,
            Network::Signet => 45213,
            unsupported => unsupported_network(unsupported),
        };
        let default_daemon_p2p_port = match config.network {
            Network::Bitcoin => 15212,
            Network::Testnet => 25212,
            Network::Testnet4 => 55212,
            Network::Regtest => 35212,
            Network::Signet => 45212,
            unsupported => unsupported_network(unsupported),
        };
